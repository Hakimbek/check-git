...
const queryService = __importStar(require("./Query.service"));
const constants_1 = require("../../config/constants");
const externalDependencies_1 = require("../../externalDependencies");
const getAnswerForQNABox = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { query: { query }, body: { permissions }, isFreemium, } = req;
        res.send(yield queryService.getDictionaries(req, { query, permissions, isFreemium }));
    }
    catch (error) {
...
// Full API url:
// /service/edge/services/query/dictionaries
const router = express_1.Router();
router.post('/dictionaries', setIsFreemiumMiddleware, getAnswerForQNABox);
